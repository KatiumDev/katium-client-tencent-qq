...
fun createLoginRequest(client: QQClient, sequenceID: Int) = TransportPacket.Request.Oicq(
    client = client,
    ...
    packet = OicqPacket.Request.Buffered(
        uin = client.uin.toInt(),
        command = 0x0810,
        encryptionMethod = EncryptionMethod.ECDH,
